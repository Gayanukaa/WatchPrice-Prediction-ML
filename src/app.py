...
# The JSON we receive should be converted to something the model can understand.
# So we create a class with fills associated with JSON
# Base model that support FastAPI is pydantic BaseModel which will convert all the json.
# We make input as a ProductModel type
@app.post('/predict')
